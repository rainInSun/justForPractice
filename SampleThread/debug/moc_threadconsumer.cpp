/****************************************************************************
** Meta object code from reading C++ file 'threadconsumer.h'
**
...
#error "The header file 'threadconsumer.h' doesn't include <QObject>."
...
void ThreadConsumer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ThreadConsumer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ThreadConsumer::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadConsumer::newValue)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ThreadConsumer::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_ThreadConsumer.data,
    qt_meta_data_ThreadConsumer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
